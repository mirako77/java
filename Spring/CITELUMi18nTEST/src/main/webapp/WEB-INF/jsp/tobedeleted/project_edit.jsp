...
<div class="right_col" role="main">
	<div class="page-title">
		<div class="title_left">
			<h3>Modifier un projet existant: ${getCurrentProjectName}</h3>
		</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<i class="fa fa-folder"></i><a href="profile" style="font-weight: bold;"> Tableau de bord</a> > <a href="project_list" style="font-weight: bold;">Liste des projets</a> > Edit Project 
...
<%-- 					<c:url var="addAction" value="/web/submit_form/edit" ></c:url> --%>
<%-- 					<%@ include file="../shared/project_form.jspf"%> --%>
<%-- 					<c:url var="addAction" value="loginServlet" ></c:url> --%>

						<form:form id="demo-form2" class="form-horizontal form-label-left" action="${addAction}" method="POST" commandName="projects">
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Titre du projet<span class="required">*</span></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" path="title" value="${getCurrentProjectName}"/>
								</div>
							</div>
	<!--  line Break -->
	...
	<!--  line Break -->
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
	<!--  <input type="text" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12" style="height:250px">   -->
	
									<form:textarea rows="5" id="editDescription" type="text" class="form-control col-md-7 col-xs-12" path="description"/>
								</div>
							</div>
	
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">état etat du projet <span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" path="project_status" value="${getCurrentProjectStatus}"/>
								</div>
							</div>
							<!--  line Break -->
<!-- 							<div class="ln_solid"></div>
							 line Break
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Upload Image</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input class=" col-md-7 col-xs-12" type="file" accept="image/*" style="padding-top: 8px;">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Upload File</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input class=" col-md-7 col-xs-12" type="file" style="padding-top: 8px;">
								</div>
							</div> -->
							<div class="ln_solid"></div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Deadline
								<span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input id="deadline" type="text" required="required" class="form-control col-md-7 col-xs-12" path="deadline" readOnly="readOnly" value="${getCurrentDeadline}" title="Click to edit deadline"/>
								</div>
							</div>
							<div class="ln_solid"></div>
							<div class="form-group">
								...
								<ul class="list-inline pull-right">
									<li>
										<button type="button" class="btn btn-primary next-step" onclick="$('.btnForm').click()">Save and continue</button>
									</li>
								</ul>
							</div>
...
<!--     Load page-specific scripts -->
    ...
    <script>
    	...
    	document.getElementById("editDescription").defaultValue = "${getCurrentProjectDescription}";
	...
	<!-- bootstrap-daterangepicker -->
<script src="${pageContext.request.contextPath}/scripts/custom_bootstrap-daterangepicker.js"></script>
	<!-- /bootstrap-daterangepicker -->
