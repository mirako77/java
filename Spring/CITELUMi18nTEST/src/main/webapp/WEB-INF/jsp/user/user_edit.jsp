...
<div class="right_col" role="main">
	<div class="page-title">
		<div class="title_left">
			<h3><i class="fa fa-users"></i> Modifier un utilisateur existant: ${user.name}</h3>
		</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<i class="fa fa-users"></i> Utilisateurs > Liste des utilisateurs > Modifier un utilisateur

				<div class="x_title">
					<div class="col-md-6">
						<h3 style="margin-left:20%;">Formulaire de modification</h3>
					</div>
...
<%-- 					<c:url var="addAction" value="/web/edit_project=${getCurrentProjectId}" ></c:url> --%>
					<c:url var="addAction" value="/web/submit_form/user_edit" ></c:url>
