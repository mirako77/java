...
<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<i class="fa fa-edit"></i> Projets > Edit Project
					...
					<div class="wizard-inner">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation" class="${wizardCompleted}"><a
									href="project${getCurrentProjectId}_preview"
									data-toggle="${tab}" aria-controls="step2"
...
<%-- 					<c:url var="addAction" value="/web/edit_project=${getCurrentProjectId}" ></c:url> --%>
					<c:url var="addAction" value="/web/submit_form/project_edit" ></c:url>
					<%@ include file="../shared/project_form.jspf"%>
								...
								<ul class="list-inline pull-right">
									<li>
										<button type="button" class="btn btn-primary next-step" onclick="$('.btnForm').click()">Suivant</button>
									</li>
								</ul>
							</div>
