				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Créer un nouveau base documentaire</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<i class="fa fa-folder"></i><a href="profile"
									style="font-weight: bold;"> Tableau de bord</a> > Créer un
								projet
								...
								<div class="x_content">
									...
									<c:url var="addAction" value="/web/submit_form/add"></c:url>
									<%@ include file="../shared/template_form.jspf"%>
<
								...
								<!--  Step 1 form End -->
												...
												<ul class="list-inline pull-right">
													<li>
														<button type="button" class="btn btn-primary" onclick="$('.btnForm').click()">Save and continue</button>
													</li>
												</ul>
											</div>
