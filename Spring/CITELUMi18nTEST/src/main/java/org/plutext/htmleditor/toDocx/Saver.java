	...
	/*
	  ...
	  */  
	    ...
	    ChapterValue chapVal = new ChapterValue();
			...
			//String savePath = path + "folders\\" + projString + "\\" + chapValString + ".docx";
...
//			@Context UriInfo info,
		...
		try {
			...
			builder.header("Content-Disposition", "filename=result.docx");
