...
public class LDAPTest {
     ...
     */
    public static void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, NamingException {
        
        final String ldapAdServer = "ldap://localhost:10389";
        final String ldapSearchBase = "dc=ad,dc=my-domain,dc=com";
        
        final String ldapUsername = request.getParameter("yourName");
        final String ldapPassword = request.getParameter("yourPassword");
